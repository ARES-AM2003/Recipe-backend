...
export class Initi1759593076660 implements MigrationInterface {
    name = 'Initi1759593076660'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "recipes_liked_by_users" ("recipesId" uuid NOT NULL, "usersId" uuid NOT NULL, CONSTRAINT "PK_4cd06043e1bb70def096792d867" PRIMARY KEY ("recipesId", "usersId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_7e6d5bdc3c9e4b6673102b480b" ON "recipes_liked_by_users" ("recipesId") `);
        await queryRunner.query(`CREATE INDEX "IDX_fefefa463f05e61e8ec8e3f5da" ON "recipes_liked_by_users" ("usersId") `);
        ...
        await queryRunner.query(`ALTER TABLE "recipes_liked_by_users" ADD CONSTRAINT "FK_7e6d5bdc3c9e4b6673102b480b4" FOREIGN KEY ("recipesId") REFERENCES "recipes"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "recipes_liked_by_users" ADD CONSTRAINT "FK_fefefa463f05e61e8ec8e3f5da7" FOREIGN KEY ("usersId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "recipes_liked_by_users" DROP CONSTRAINT "FK_fefefa463f05e61e8ec8e3f5da7"`);
        await queryRunner.query(`ALTER TABLE "recipes_liked_by_users" DROP CONSTRAINT "FK_7e6d5bdc3c9e4b6673102b480b4"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_fefefa463f05e61e8ec8e3f5da"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_7e6d5bdc3c9e4b6673102b480b"`);
        await queryRunner.query(`DROP TABLE "recipes_liked_by_users"`);
